# GEOG5991Assignment2GitHub


Read me:

A user of the program only has three inputs to make, to run the 
program successfully. These inputs include; selecting the raster grid 
